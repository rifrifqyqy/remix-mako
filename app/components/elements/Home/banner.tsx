...
export default function HomeBanner() {
  ...
  return (
    <>
      <motion.main initial="hidden" animate="visible" className="grid grid-cols-5 gap-8">
        <div className="col-span-2 h-full flex justify-start">
          <motion.div className="flex flex-col gap-4">
            <motion.h1 variants={Anitxt1} className="text-4xl text-dark-50 font-semibold h-fit">
              Indulge yourself with our premium bread and pastries.
            </motion.h1>
            <motion.p variants={AnitxtDown} className="text-dark-200">
              Made with the finest ingredients and traditional techniques, Our premium bread and pastries are not just treats; they are an experience crafted to elevate your palate and satisfy your cravings.
            </motion.p>
            <section className="flex w-full my-2 justify-center gap-12 text-main-50">
              <motion.div variants={AniScale} className="flex flex-col items-center">
            ...
            <motion.section variants={AniScaleDown} className="bg-zinc-100 rounded-xl mt-auto flex flex-col p-4 left-0">
              <h1 className="text-lg font-medium text-main-50">Savor the quality and passion in every loaf and pastry, baked fresh daily just for you.</h1>
              <img
                ...
                className="h-44 object-cover my-4 rounded-lg brightness-[85%]"
                alt=""
              />
              <RemixButton color="bg-main-50" style="w-fit ml-auto flex gap-2 pr-2 rounded-full group/arrow" onClick={handleMenu}>
                Lihat Menu
                <svg width="24" height="24" className="group-hover/arrow:rotate-45 transition-all" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
